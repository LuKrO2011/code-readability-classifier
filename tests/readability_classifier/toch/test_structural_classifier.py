...
from src.readability_classifier.toch.structural_model import StructuralModel
from tests.readability_classifier.toch.test_structural_model import create_test_data
