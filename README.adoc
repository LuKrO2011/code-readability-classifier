...
4. Use https://docs.github.com/en/repositories/working-with-files/managing-large-files/installing-git-large-file-storage[git lfs] to download the models & datasets:
[source,bash]
git lfs install
git lfs pull
