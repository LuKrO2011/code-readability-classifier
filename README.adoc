...
[source,bash]
----
podman run -it --rm <your-container-name>
----

or by using the provided `src/readability_classifier/utils/cuda-check.py` script:

[source,bash]
----
podman run -it --rm <your-container-name> python src/readability_classifier/utils/cuda-check.py
----
