...
from readability_classifier.models.semantic_model import SemanticModel
...
class SemanticClassifier(BaseClassifier):
    ...
    def _batch_to_input(self, batch: dict) -> ModelInput:
        ...
        """
        _, input_ids, token_type_ids, _, _ = self._extract(batch)
        input_ids = input_ids.to(self.device)
        token_type_ids = token_type_ids.to(self.device)
        return SemanticInput(input_ids, token_type_ids)
